...
export 'package:location/src/location_define.dart';

import 'location_platform_interface.dart';

export 'location_platform_interface.dart'
...
class Location {
  ...
  Future<void> updateOption(Map optionMap) {
    return LocationPlatform.instance.updateOption(optionMap);
  }
}
